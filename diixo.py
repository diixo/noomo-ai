...
diixo = [
    ...
    'negativ', 'render', 'surrender', 'surround', 'surpris', 'suspend', 'surrogate', 'suspect', 'surve', 'suspens', 'surviv',# 'con'
    ...
    'legac', 'legib', 'discount', 'discourag', 'discreet', 'led', 'amo', 'assail', 'crumbl', 'leap', 'baffl', 'flavo', 'fixat',
    ...
    'swallow', 'swag', 'swaddl', 'sneez', 'snack', 'snail', 'snak', 'lous', 'por', 'porn', 'pork', 'oration', 'owe', 'owl', 'meow',
    # ord, ulate, ulation, ster, sters, rupt, rupted, ner, ues, 'ex', 'exe', 'exc', ped?
